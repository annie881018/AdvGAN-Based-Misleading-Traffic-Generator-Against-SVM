...
for %%a in (%alphas%) do (
    for %%b in (%betas%) do (
        for %%t in (%threshes%) do (   
            echo Running: python AdvGAN_main.py --num_data 100 --thresh %%t --alpha %%a --beta %%b --lr 0.000001 --epochs 10000 --batch_size 10
            python AdvGAN_main.py --num_data 100 --thresh %%t --alpha %%a --beta %%b --lr 0.000001 --epochs 10000 --batch_size 10
