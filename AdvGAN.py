...
class AdvGAN_attack:
    def __init__(self,
        ...
        self.discriminator = Discriminator.build_discriminator(feature_dim=self.feature_dim)
        self.target_model = Discriminator_SVM.build_discriminator()
        self.num = num
    ...
    def train_step(self, X):
        ...
        with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
            ...
            # generator loss
            g_loss_perturb = self.mse(tf.ones_like(d_perturbed_probs), d_perturbed_probs)
